...
contract DEX {
    ...
    uint256 public totalLiquidity; //total liquidity of the contract
    mapping(address => uint256) public liquidity; // mapping of addresses to their liquidity
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        require(sent, "DEX: tokenToEth() - revert in transferring eth to you!");
        emit TokenToEthSwap(
            msg.sender,
            "Balloons to ETH",
            ethOutput,
